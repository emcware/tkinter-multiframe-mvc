...
class FileTreeView:
    def __init__(self, parent, folder_path, label_text):
...
class Application(tk.Tk):
    def __init__(self):
        ...
        # File view 1 (Link Files)
        self.link_files_view = FileTreeView(right_frame, '/Users/mikekriege/EMC/Factors', 'Link Files')

        # File view 2 (Limits)
        self.limits_view = FileTreeView(right_frame, '/Users/mikekriege/EMC/Limits', 'Limits')
